var init = function (window) {
    ...
    // TODO 2 : add background
        var background = opspark.makeBackground(app,ground); // create a var called background to hold the background 
        view.addChild(background) // adds the background to the viewport so we can see it
    ...
    // TODO 1 : add a heads-up display to game
        ...
        view.addChild(hud); // add the hud to the cavas and amke it veiwable 
        window.hud = hud; // resgiters the hud in the window 
